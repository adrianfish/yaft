CREATE TABLE YAFT_FORUM (FORUM_ID CHAR(36) NOT NULL
							...
							,STATUS VARCHAR2(36) NOT NULL,CONSTRANUMBER(10,0) yaft_forum_pk PRIMARY KEY (FORUM_ID));
...
CREATE TABLE YAFT_FORUM_DISCUSSION (FORUM_ID CHAR(36) NOT NULL
							...
							,CONSTRANUMBER(10,0) yaft_forum_discussion_pk PRIMARY KEY (FORUM_ID,DISCUSSION_ID));
